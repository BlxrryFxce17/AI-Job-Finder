...
router.get('/', requireAuth, apiLimiter, jobController.getJobs);
...
router.post('/single-draft', requireAuth, aiLimiter, emailLimiter, singleDraft, jobController.singleDraft);
